...
public class HiFiApplication extends Application {
    private static String dbName = "HF";
    ...
    private void copyDatabaseToDevice() {
        ...
        try {
            ...
            setDBPathName(dataDirectory.toString() + "/" + getDBPathName());
    ...
    private static void setDBPathName(final String name) {
        try {
